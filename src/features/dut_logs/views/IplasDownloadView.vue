            ...
            <v-card-text>
              <v-form @submit.prevent="handleDownload">
                ...
                <v-text-field
                  ...
                  placeholder="Enter device ISN (e.g., ABC123456)"
                  :rules="[rules.required]"
                  hint="Device serial number from iPLAS Explorer"
                  persistent-hint
                  class="mb-4"
                />
                ...
                <v-text-field
                  ...
                  :rules="[rules.required]"
                  hint="Device ID from iPLAS Explorer"
                  persistent-hint
                  class="mb-4"
                />
                ...
                <v-text-field
                  ...
                  :rules="[rules.required]"
                  hint="Station name from iPLAS Explorer"
                  persistent-hint
                  class="mb-4"
                />
                ...
                <v-text-field
                  ...
                  :rules="[rules.required]"
                  hint="Exact test time from iPLAS Explorer"
                  persistent-hint
                  class="mb-4"
                />
        ...
        <v-col cols="12">
          <v-card variant="outlined">
            ...
            <v-card-text>
              <v-list density="compact">
                <v-list-item
                  v-for="(download, index) in recentDownloads"
                  :key="index"
                >
                  <template #prepend>
                    <v-icon
                      :color="download.status === 'success' ? 'success' : 'error'"
                      size="small"
                    >
        ...
        <v-col cols="12" md="6">
          <v-card variant="outlined">
            <v-card-text class="d-flex align-center">
              <v-icon
                :color="apiReachable ? 'success' : 'error'"
                class="mr-2"
              >
