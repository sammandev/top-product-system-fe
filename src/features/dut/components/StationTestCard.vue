                        ...
                        <v-card-text>
                            <v-list density="compact">
                                ...
                                <v-list-item>
                                    ...
                                    <v-list-item-subtitle
                                        style="white-space: normal; word-break: break-word; text-overflow: clip; overflow-wrap: break-word;">
    ...
    <v-expansion-panels v-else>
        <v-expansion-panel>
            ...
            <v-expansion-panel-text class="pa-0">
                <!-- Test Records -->
                <v-row class="ma-0">
                    <v-col v-for="(record, index) in station.data" :key="record.id" cols="12" :sm="6" :md="6" :lg="4"
                        class="pa-2">
                        <v-card variant="flat" class="h-100" :color="record.test_result !== 1 ? 'red-lighten-5' : ''">
                            <v-card-title class="text-subtitle-1">
                                Test Record #{{ index + 1 }}
