                        ...
                        <v-row>
                            <v-col cols="12">
                                <v-text-field :model-value="getServerConfig(server.id).baseIp"
                                    @update:model-value="setServerBaseIp(server.id, $event)" label="Server IP Address"
                                    variant="outlined" density="comfortable" prepend-inner-icon="mdi-ip-network"
                                    hint="e.g., 10.176.33.89" persistent-hint />
                            </v-col>
                        </v-row>
                        ...
                        <v-row class="mt-3">
                            <v-col cols="12">
                                <v-textarea :model-value="getServerConfig(server.id).token"
                                    @update:model-value="setServerToken(server.id, $event)" label="Access Token"
                                    variant="outlined" density="comfortable" prepend-inner-icon="mdi-key" rows="3"
