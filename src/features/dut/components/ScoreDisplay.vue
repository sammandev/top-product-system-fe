...
const textSizeClass = computed(() => {
    switch (props.size) {
        case 'x-small': return 'text-caption'
        case 'small': return 'text-body-2'
        case 'large': return 'text-h6'
