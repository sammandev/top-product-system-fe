...
const recordIconToneClass = (record: TestRecord) =>
  isSuccessfulRecord(record)
    ? 'test-log-view__record-icon--success'
    : 'test-log-view__record-icon--danger'

const recordCardToneClass = (record: TestRecord) =>
  isSuccessfulRecord(record)
    ? 'test-log-view__record-card--success'
    : 'test-log-view__record-card--danger'

const recordRowToneClass = (record: TestRecord) =>
  isSuccessfulRecord(record)
    ? 'test-log-view__record-row--success'
    : 'test-log-view__record-row--danger'
