...
export async function getTopProductsList(
  params: TopProductListParams = {},
): Promise<TopProductListResponse> {
 ...
 */
export async function createTopProductsBulk(
  data: TopProductBulkCreate,
): Promise<TopProductBulkCreateResponse> {
 ...
 */
export async function deleteTopProduct(
  productId: number,
