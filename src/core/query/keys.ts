export const queryKeys = {
  ...
  iplas: {
    ...
    stations: (site: string, project: string, credentialScope = 'configured') =>
      [...queryKeys.iplas.all, 'stations', site, project, credentialScope] as const,
    ...
    isnSearchBatch: (params: unknown) =>
      [...queryKeys.iplas.all, 'isn-search-batch', params] as const,
    stationsFromIsn: (params: unknown) =>
      [...queryKeys.iplas.all, 'stations-from-isn', params] as const,
    stationsFromIsnBatch: (params: unknown) =>
      [...queryKeys.iplas.all, 'stations-from-isn-batch', params] as const,
    stationSearchRun: (runId: string) =>
      [...queryKeys.iplas.all, 'station-search-run', runId] as const,
