...
test.describe('Authentication Flows', () => {
  ...
  test.describe('Local Login', () => {
    ...
    test('CRITICAL: should display error inline without page refresh on login failure', async ({ page }) => {
      ...
      await expect(page.getByRole('alert').filter({ hasText: /invalid|incorrect|failed/i })).toBeVisible()
    ...
    test('should clear error message when closing alert', async ({ page }) => {
      ...
      await expect(page.getByRole('alert').filter({ hasText: /invalid|incorrect|failed/i })).not.toBeVisible()
    })
    ...
    test('should handle network errors gracefully', async ({ page }) => {
      ...
      await expect(page.getByRole('alert').filter({ hasText: /error|network|failed/i })).toBeVisible()
  ...
  test.describe('Responsive Design', () => {
    test('should be usable on mobile', async ({ page, viewport }) => {
      // Set mobile viewport
